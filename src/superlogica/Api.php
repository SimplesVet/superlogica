...
class Superlogica_Api
{
    ...
    public function getData($retornoOuIndice = '0')
    {
        ...
        } elseif ((is_array($this->_retorno['data'])) && (is_array($this->_retorno['data'][$retornoOuIndice])) && ($this->_retorno['data'][$retornoOuIndice]["data"])) {
            $dados = $this->_retorno['data'][$retornoOuIndice]["data"];
        } elseif (is_array($this->_retorno['data'][$retornoOuIndice])) {
